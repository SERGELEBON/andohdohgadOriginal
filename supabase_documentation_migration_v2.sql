...
-- Version 2 (Fixed) - Date : 2026-07-17
-- ===============================================
...
BEGIN
  ...
  -- Insérer les traductions (FIX: utiliser current_doc_id au lieu de doc_id)
  FOREACH current_doc_id IN ARRAY doc_ids
  LOOP
    INSERT INTO public.documentation_translations (doc_id, language, title, description)
    VALUES (current_doc_id, 'fr', titles[i], descriptions[i])
